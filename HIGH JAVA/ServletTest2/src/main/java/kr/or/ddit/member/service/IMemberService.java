...
/**
 * Service객체는 DAO에 설정된 메소드를 원하는 작업에 맞게
 * 호출하여 결과를 받아오고, 받아온 결과를 Controller에게
 * 보내주는 역할을 한다.
 *  
 * @author PC-14
 *
...
public interface IMemberService {
	...
	/**
		...
		/**
		 * 매개변수로 넘어온 회원ID를 갖는 회원 정보 1개를 검색해서 반환하는 메서드
		 * @param memId 검색할 회원ID
		 * @return 검색한 결과가 저장된 MemberVO객체
		 */
