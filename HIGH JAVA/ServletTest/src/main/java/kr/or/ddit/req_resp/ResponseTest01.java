	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		/*
		 - forward 방식
		   ...
		   사용자(클라이언트)의 웹브라우저의 URL주소가 바뀌지 않고 처음 요청할 때의 값으로 유지된다.
		   
		   서버 내부에서만 접근이 가능하다.
		 */
		
		// 이 곳에서 만든 데이터를 이동되는 페이지로 넘길 수 있는데 이 때 사용하는 메서드는 Request객체의 setAttribute()메서드를 사용한다.
		...
		// ==> 객체를 생성할 때 이동할 서블릿이나 JSP의 주소를 기술하는데 전체 URL 중에서 ContextPath이후의 내용을 기술하면 된다.
