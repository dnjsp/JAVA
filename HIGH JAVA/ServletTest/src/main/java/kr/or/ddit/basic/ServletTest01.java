...
// Servlet이란? 웹 컨테이너에 의해 관리되는 자바 기반 웹 컴포넌트로서 동적인 웹 컨텐츠 생성을 가능하게 한다.

/*
 	http://localhost:8081/servletTest/servletTest01.do
 	- http ==> 프로토콜
 	...
 	- 이 예제는 배포서술자(DD, Deployment Descriptor => web.xml문서)를 이용해서 실행할 servlet을 설정하여 처리하는 예제이다.
 */
...
public class ServletTest01 extends HttpServlet {
	...
	// doGet()메서드나 doPost()메서드는 service()메서드를 통해서 호츨된다.
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.append("<title>첫 번째 Servlet 연습</title>");
		out.append("<body>");
		out.append("<h1 style='text-align: center;'>");
		out.append("안녕하세요. 첫 번째 Servlet프로그램입니다.<br>");
